...
class RegistroActivity : AppCompatActivity() {
    ...
    fun cargarDatos(){
        ...
        val url = "http://192.168.43.157/android_mysql_app/consulta.php?id=$id"
    ...
    fun eliminar(Vista: View){
        val url = "http://192.168.43.157/android_mysql_app/borrar.php"
        procesoEnCola= Volley.newRequestQueue(this)
    ...
    fun editar(Vista: View){
        val url = "http://192.168.1.3/android_mysql_app/editar.php"
        procesoEnCola = Volley.newRequestQueue(this)
